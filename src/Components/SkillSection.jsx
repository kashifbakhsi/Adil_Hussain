...
const skills = [
  // Engineering
  { name: "Structural Planning", level: 90, category: "engineering" },
  { name: "Site Execution", level: 95, category: "engineering" },
  { name: "Construction Management", level: 90, category: "engineering" },
  { name: "AutoCAD Drafting", level: 85, category: "engineering" },

  // Design
  { name: "Modular Kitchen Design", level: 95, category: "design" },
